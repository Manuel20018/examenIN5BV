...
import com.manuelmarroquin.sessionsbeans.AreasFacadeLocal;
    ...
    public static class AreasControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Areas) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + Areas.class.getName());
            }
        }
