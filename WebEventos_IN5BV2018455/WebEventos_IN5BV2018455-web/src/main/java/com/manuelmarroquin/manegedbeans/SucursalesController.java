...
import com.manuelmarroquin.sessionsbeans.SucursalesFacadeLocal;
...
public class SucursalesController implements Serializable {
    ...
    public String prepareView() {
        current = (Sucursales) getItems().getRowData();
    ...
    public static class SucursalesControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Sucursales) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + Sucursales.class.getName());
            }
        }
